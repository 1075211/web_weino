	...
	<body bgcolor="#222222">
		<div>
			...
			<div class="search-box">
				<input class="search-txt" type='text' id='inp' placeholder="What are you looking for?" onkeyup="showHint(this.value)"/>
		...
		<script>
			    ...
			    function Search() {
			        var url = '/showHot.php?Title=' + oInp.value;
			        window.open(url);
			    }
			</script>
		...
		<div class="main w" id="pa">
		   ...
		   echo "<tr>"."<td><a href='press.php?id=".$info['passageId']."'><input id='pinglun' value='评论' class='before_press' type='button'></a></td><td><input id='dianzan".$info['passageId']."'  value='点赞' type='button' class='button' onclick='ajaxRequest2".$info['passageId']."()'>"."</td></tr>";
